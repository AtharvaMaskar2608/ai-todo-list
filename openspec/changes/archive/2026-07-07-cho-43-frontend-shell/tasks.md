...
- [ ] 1.1 Create `frontend/index.html` with the Tailwind CDN, an inline
...
- [ ] 1.2 Add the responsive centered layout skeleton (`max-w-[900px]`, centered,
...
- [ ] 1.3 Create `frontend/css/style.css` (custom animations / glassmorphism
...
- [ ] 2.1 Create `frontend/js/config.js` exporting
...
- [ ] 2.2 Create `frontend/js/api.js` exporting `ApiError(status, detail)` and
...
- [ ] 3.1 Create `frontend/js/store.js` exporting `store` with `getTodos()`,
...
- [ ] 4.1 Create `frontend/js/ui/toast.js` exporting `showToast(message, type)`
...
- [ ] 4.2 Create `frontend/js/ui/modal.js` exporting `openModal(el)` and
...
- [ ] 4.3 Create `frontend/js/ui/skeleton.js` exporting `showSkeletons(container,
...
- [ ] 5.1 Create `frontend/js/features/theme.js` exporting `initTheme()` that
...
- [ ] 5.2 Create `frontend/js/features/quote.js` exporting `initQuote()` that
...
- [ ] 6.1 Create `frontend/js/main.js` that on load runs `initTheme()` and
...
- [ ] 7.1 Serve `frontend/` via a static server and verify the shell end-to-end —
